...
background: rgba(255, 255, 255, 0.7);  /* Warna acrylic */
...
menu = st.sidebar.radio('Pilih Menu', ['Halaman Utama', 'Pengertian Titik Sampling', 'Penjelasan Baku Mutu', 'Perhitungan dan Hasil'])
...
if menu == 'Halaman Utama':
    ...
    st.write(
        """\
        **Selamat datang di aplikasi perhitungan titik sampling pada cerobong. Aplikasi ini membantu untuk menentukan titik lintas pada penyamplingan cerobong dengan hasil rekomendasi yang di berikan.**
        
        **Pembuatan aplikasi ini hasil dari proyek pembuatan kami dari mata kuliah yang diambil.**
